...
export function TestimonialsColumnsTemplate({ time, width, height, values }: HtmlTemplateProps) {
  ...
  const testimonials = useMemo(() => [
    ...
    },
    {
      ...
      image: String(values.image4 ?? placeholderImage("matfitcrop")),
    ...
    },
    {
      ...
      image: String(values.image5 ?? placeholderImage("matfitcrop")),
    ...
    },
    {
      ...
      image: String(values.image6 ?? placeholderImage("matfitcrop")),
