...
export function DitheringShader({
  ...
  useEffect(() => {
    ...
    // Animation loop
    const render = () => {
      const currentTime = time !== undefined ? time : (Date.now() - startTimeRef.current) * 0.001 * speed
  ...
  }, [width, height, colorBack, colorFront, shape, type, pxSize, speed, time])
