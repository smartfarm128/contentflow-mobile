...
export function GlowingShadow({ 
  ...
  const inlineStyles = {
    ...(hueOverride !== undefined ? { '--hue': hueOverride } : {}),
    ...(rotateOverride !== undefined ? { '--rotate': rotateOverride } : {}),
    ...(bgXOverride !== undefined ? { '--bg-x': bgXOverride } : {}),
    ...(bgYOverride !== undefined ? { '--bg-y': bgYOverride } : {}),
  ...
  return (
    <>
      <style>{`
        ...
        /* Scrubbing mode: disable CSS animations */
        .glow-container.scrubbing .glow-content:before,
        .glow-container.scrubbing .glow,
        .glow-container.scrubbing .glow:after {
      ...
      <div 
        className={`glow-container ${isScrubbing ? 'scrubbing' : ''} ${className}`} 
        style={inlineStyles}
        role="button"
      >
